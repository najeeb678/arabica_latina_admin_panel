...
import { ProductVariants as ProductVariantsType, ButtonConfig } from "@/types/types"; // Use alias for type
...
const ProductVariantsList = () => {
   ...
   const { ProductVariants, loading } = useSelector((state: RootState) => state.productsVariants); // Use ProductVariants from state
